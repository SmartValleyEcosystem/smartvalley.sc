...
contract VotingSprintMock is VotingSprint {
    constructor(uint _number, uint _durationDays, uint256[] _projectsIds, uint _acceptanceThreshold, address _token, address _freezer) VotingSprint(_number, _durationDays, _projectsIds, _acceptanceThreshold, _token, _freezer) public { 
    }
